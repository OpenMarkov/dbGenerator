...
/**
 * Class that filter only the files that contain Elvira databases.
 * 
 * @author joliva
 * @author manuel      
 * @author fjdiez          
...
public class FileFilterDbc extends FileFilterBasic {
    /**
     * String resource.
     */
     ...
     */
    private String filterExtension = "dbc";


    /**
     * Create a new instance and create a new string resource.
     */
    public FileFilterDbc() {
        super();
        stringResource =
    ...
    /**
     * Returns the description of the dbc files
     * 
     * @return a string representing the description of the files type
     */
    @Override
    public String getDescription() {
        return stringResource.getString("FileExtension.ElviraDB.Description")
            + " (*." + filterExtension + ")";
    }
